...
#'
#' @param input_variables Table of specifications for requested dataset: model type, date range, variables (list)
#' @param lat Latitude specifications for area of interest (list)
#' @param lon Longitude specifications for area of interest (list)
#' @param web_link A web link to the api data source you want to read (character)
#' @param verbose If True detailed processing information will be output (logical)
#'
#' @importFrom magrittr %>%
